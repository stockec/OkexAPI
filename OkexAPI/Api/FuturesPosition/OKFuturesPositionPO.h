...
@interface OKFuturesPositionPO : NSObject
...
@property(nonatomic,strong) NSString *long_settlement_price; // long_settlement_price    String    多仓结算基准价
...
@property(nonatomic,strong) NSString *short_settlement_price; // short_settlement_price    String    空仓结算基准价
