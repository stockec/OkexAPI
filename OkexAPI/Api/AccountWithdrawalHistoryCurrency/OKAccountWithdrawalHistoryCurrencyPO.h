//
//  OKAccountWithdrawalHistoryCurrencyPO.h
//  AutoAPI
//
...
@interface OKAccountWithdrawalHistoryCurrencyPO : NSObject
...
@property(nonatomic,strong) NSString *fee; // fee    String    提币手续费和对应币种，如0.00000009btc
@property(nonatomic,strong) NSString *status; // status    String    提现状态（-3:撤销中;-2:已撤销;-1:失败;0:等待提现;1:提现中;2:已汇出;3:邮箱确认;4:人工审核中5:等待身份认证）
