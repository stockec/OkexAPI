//
//  OKMarginAccountsInstrument_idBorrowedRO.h
//  AutoAPI
//
...
@interface OKMarginAccountsInstrument_idBorrowedRO : NSObject

@property(nonatomic,strong) NSString *status; // status    string    [非必填]状态(0:未还清 1:已还清)
