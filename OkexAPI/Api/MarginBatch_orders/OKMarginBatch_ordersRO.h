...
@interface OKMarginBatch_ordersRO : NSObject
...
@property(nonatomic,strong) NSString *margin_trading; // margin_trading    string    否    下单类型(当前为币币杠杆交易，请求值为2)
