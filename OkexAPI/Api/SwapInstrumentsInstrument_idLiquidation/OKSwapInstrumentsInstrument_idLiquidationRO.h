//
//  OKSwapInstrumentsInstrument_idLiquidationRO.h
//  AutoAPI
//
...
@interface OKSwapInstrumentsInstrument_idLiquidationRO : NSObject

@property(nonatomic,strong) NSString *instrument_id; // instrument_id    String    是    合约名称，如BTC-USD-SWAP
@property(nonatomic,strong) NSString *status; // status    String    是    状态(0:最近7天的未成交 1:最近7天的已成交)
...
@property(nonatomic,strong) NSString *limit; // limit    String    否    分页返回的结果集数量，默认为100，最大为100，按时间倒序排列，越晚的订单在前面
